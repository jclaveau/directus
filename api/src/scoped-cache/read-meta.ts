 ...
 *
 * Fingerprints and nothing else: a label is a rendering of one, taken in `respond`
 * for the dev headers and the telemetry, and a consumer handed a flat list of
 * them would have lost the AND that makes a fingerprint a slice rather than a
 * collection.
 */
