...
import { getSharpCounters, getSharpInstance } from "./files/lib/get-sharp-instance.js";
	...
	async getAsset(id, transformation, range, deferStream = false) {
		...
		*/
		...
		if (type && transforms.length > 0 && SUPPORTED_IMAGE_TRANSFORM_FORMATS.includes(type)) {
			...
			if (transforms.find((transform) => transform[0] === "rotate") === void 0) transformer.rotate();
			try {
