...
var GraphQLService = class {
	...
	*/
	async read(collection, query) {
		...
		return this.schema.collections[collection].singleton ? await service.readSingleton(query, { stripNonRequested: false }) : await service.readByQuery(query, { stripNonRequested: false });
	}
	/**
