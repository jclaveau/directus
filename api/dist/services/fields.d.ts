...
export declare class FieldsService {
    ...
    listExistingIndexes(trx: Knex): Promise<{
        table: string;
        column: string;
        index: string;
    }[]>;
    addColumnToTable(table: Knex.CreateTableBuilder, collection: string, field: RawField | Field, existing?: Column | null, existingIndexes?: Awaited<ReturnType<typeof this.listExistingIndexes>>): void;
}
