	...
	*/
	...
	async createMany(data, opts = {}) {
		...
		if (shouldClearCache(this.cache, opts, this.collection)) {
			...
			this.scopedCachePurged = await this.scopedCache.purge(scopedCacheTags, scopedCacheCollector, [], { includeCollectionTag: opts.purgeCollectionTag !== false });
		}
		return results;
	}
	/**
	...
	*/
	...
	async deleteMany(keys, opts = {}) {
		...
		if (shouldClearCache(this.cache, opts, this.collection)) {
			...
			this.scopedCachePurged = await this.scopedCache.purge(scopedCacheTags, scopedCacheCollector, scopedCacheCollectionsChangedByOnDelete(this.schema, this.collection), { includeCollectionTag: opts.purgeCollectionTag !== false });
		}
		if (opts.emitEvents !== false) await emitActionEvents([{
