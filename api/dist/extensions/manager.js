...
var ExtensionManager = class {
	...
	*/
	appExtensionChunks = /* @__PURE__ */ new Map();
	/**
	...
	*/
	async load(options) {
		...
		if (env["SERVE_APP"]) this.appExtensionsBundle = await this.generateExtensionBundle();
		this.isLoaded = true;
	...
	*/
	async generateExtensionBundle() {
		...
		try {
			...
			for (const out of output) if (out.type === "chunk") this.appExtensionChunks.set(out.fileName, out.code);
			await bundle.close();
