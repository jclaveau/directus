...
import { scopedCachePurgeEnabled, scopedCacheTagLabel, serializeScopedCacheTags, tagScopedCacheKeys } from "../scoped-cache.js";
...
const respond = async_handler_default(async (req, res) => {
	...
	let filled = false;
	if (cacheableRequest && cache && exceedsMaxSize === false && orphansInScopedMode === false && unautopurgeableScope === false && dynamicQueryFilter === false && await permissionsCachable(req.collection, {
