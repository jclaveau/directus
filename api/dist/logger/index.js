...
*/
const webSocketLogsEnabled = () => {
	const env = useEnv();
	return toBoolean(env["WEBSOCKETS_ENABLED"]) && toBoolean(env["WEBSOCKETS_LOGS_ENABLED"]);
};
...
const createExpressLogger = () => {
	...
	if (env["LOG_STYLE"] === "raw" || webSocketLogsEnabled()) httpLoggerOptions.redact = {
		paths: [
...
//#endregion
export { _cache, createExpressLogger, createLogger, getHttpLogsStream, getLoggerLevelValue, getLogsStream, useLogger, webSocketLogsEnabled };