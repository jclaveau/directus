...
import { assertScopedCacheRedisSupported } from "./scoped-cache/config.js";
import { validateBooleanEnv } from "./utils/validate-env.js";
import { isInstalled, outstandingMigrationsOrExit, validateDatabaseConnection, validateDatabaseExtensions } from "./database/index.js";
import emitter_default from "./emitter.js";
import { initCacheConfig } from "./cache-config.js";
import { startScopedCachePurgeRecovery } from "./scoped-cache/purge.js";
import "./scoped-cache.js";
import { Url } from "./utils/url.js";
import { getFlowManager } from "./flows.js";
import { getExtensionManager } from "./extensions/index.js";
import rate_limiter_global_default from "./middleware/rate-limiter-global.js";
import rate_limiter_ip_default, { resolvedRateLimiterCharge } from "./middleware/rate-limiter-ip.js";
import { initPoolHealthMirror } from "./processes/lib/pool-health.js";
import { UNDER_PRESSURE_REASON, shedUnderPressure } from "./middleware/shed-under-pressure.js";
import { assertPgBouncerConnections } from "./pgbouncer/lib/pgbouncer-config.js";
...
import { initProcessReports } from "./processes/lib/report-processes.js";
import "./processes/index.js";
import schedule from "./schedules/cache-audit.js";
...
import system_mcp_default from "./controllers/system-mcp.js";
...
import webhooks_default from "./controllers/webhooks.js";
import { flushCachesIfBuildChanged } from "./cache-build-identity.js";
import { coreMountPaths } from "./core-mounts.js";
...
import schedule$1 from "./schedules/cache-stats.js";
import schedule$2 from "./schedules/metrics.js";
...
async function createApp() {
	...
	if (outstanding.length > 0) logger.warn(`Database migrations have not all been run: ${outstanding.join(", ")}`);
	...
	app.use((req, res, next) => {
		express.json({ limit: env["MAX_PAYLOAD_SIZE"] })(req, res, (err) => {
	...
	const rateLimiterCharge = env["RATE_LIMITER_ENABLED"] === true ? resolvedRateLimiterCharge() : null;
	const useRateLimiterWhenCharging = (charge) => {
		if (rateLimiterCharge === charge) app.use(rate_limiter_ip_default);
	};
	...
	const coreRouters = {
		...
		"/dashboards": dashboards_default,
		"/extensions": extensions_default,
		"/fields": fields_default,
		"/files/tus": tus_default,
		"/files": files_default,
		"/flows": flows_default,
		"/folders": folders_default,
		"/items": items_default,
		"/system-mcp": system_mcp_default,
	...
	for (const path$1 of coreMountPaths()) app.use(path$1, coreRouters[path$1]);
