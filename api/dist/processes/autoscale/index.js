...
import { answerPoolHealthQueries, reportPoolHealth, withdrawPoolHealth } from "../lib/pool-health.js";
...
async function runAutoscaler() {
	...
	const stop = () => {
		...
		Promise.race([withdrawPoolHealth(), new Promise((resolve) => setTimeout(resolve, WITHDRAW_TIMEOUT_MS))]).finally(() => process.exit(0));
	};
