...
import "../../bus/index.js";
import { supervisorAvailable } from "../supervisor/lib/client.js";
...
async function reportSelf(query) {
	...
	const message = {
		...
		supervisor: reportsSupervisor ? await readSupervisedProcesses() : null,
		capacity: reportsSupervisor ? await hostCapacity() : null
	};
