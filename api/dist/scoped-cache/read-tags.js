...
import { m2oParentRowsAtPathEnd, resolveScopedCacheM2oJoinChainFromPath, scopedCacheFilterKeyingByCollection } from "./paths.js";
...
*/
function scopedCacheCollectionsBeyondNestedRows(schema, ast, keyingByCollection = scopedCacheFilterKeyingByCollection(schema, ast), exemptFromCaseGating = /* @__PURE__ */ new Set()) {
	const beyond = /* @__PURE__ */ new Set();
	const addCollectionsQueriedBy = (collection, query, cases, ownColumnsCovered = false) => {
	...
	const addWhatNestedNodesDependOn = (children, cases) => {
		for (const child of children) {
			...
			if (child.type === "o2m") {
				addCollectionsQueriedBy(child.name, child.query, child.cases, scopedCacheO2mChildPinnedByParentKey(schema, child.name, child.relation.field));
...
*/
function pinnedScopedCacheTagsFromM2oParents(schema, rootCollection, fieldMap, records) {
...
*/
function pinnedScopedCacheTagsFromO2mChildren(schema, rootCollection, fieldMap, records, conflictedOut) {
...
//#endregion
export { keyedFilterPinnable, pinnedScopedCacheTagsFromFilter, pinnedScopedCacheTagsFromKeyedFilters, pinnedScopedCacheTagsFromM2oParents, pinnedScopedCacheTagsFromO2mChildren, scopedCacheCollectionsBeyondNestedRows, scopedCacheNestedCollections, scopedCachePathReversesChain };