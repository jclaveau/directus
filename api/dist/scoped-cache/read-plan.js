...
var ScopedCacheReadPlan = class {
	...
	constructor(collection, schema, ast, injectedOwnershipPaths) {
		...
		this.beyondNestedRows = enabled ? scopedCacheCollectionsBeyondNestedRows(schema, ast, this.filterKeying, injectedAncestors) : /* @__PURE__ */ new Set();
	}
	/**
	...
	*/
	pinFromRows(rows) {
		...
		this.m2oParentPins = pinnedScopedCacheTagsFromM2oParents(this.schema, this.collection, this.fieldMap, toArray(rows));
		this.o2mChildPins = pinnedScopedCacheTagsFromO2mChildren(this.schema, this.collection, this.fieldMap, toArray(rows), this.o2mConflicted);
	}
	/**
