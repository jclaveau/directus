	...
	return {
		...
		scope: {
			...
			dependOn: async (lookup) => {
				...
				for (const meta of readMetasOf(resolved)) add(meta.scopedCacheTags, false, meta.scopedCacheEpochs);
				return resolved;
			}
		},
		purge: {
...
//#endregion
export { PIN_UNSAFE_SCOPE_TYPES, canonicalScopedCacheValue, createScopedCacheCollector, earlierScopedCacheEpoch, isPinnableScopeType, scopedCacheIndexPrefix, scopedCacheMaxPinsPerCollection, scopedCacheTagKey, scopedCacheTagKeyPrefix, scopedCacheTagLabel, scopedCacheTagsFromRows, serializeScopedCacheTags, takenOverScopedCacheKey };