...
*/
function mergedScopedCacheEpochs(...captures) {
	const taken = captures.filter((capture) => capture !== void 0);
	if (taken.length === 0) return;
	const merged = {};
	for (const capture of taken) mergeScopedCacheEpochs(merged, capture);
	return merged;
}
/**
...
//#endregion
export { bumpScopedCacheEpochs, foldHandedOverScopedCacheEpochs, mergeScopedCacheEpochs, mergedScopedCacheEpochs, readScopedCacheEpochs, scopedCacheCollectionsWithoutGuard, scopedCacheSweptDuringFill };