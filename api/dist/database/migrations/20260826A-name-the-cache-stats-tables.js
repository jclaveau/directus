//#region src/database/migrations/20260826A-name-the-cache-stats-tables.ts
/**
...
async function down(knex) {
	await renameEach(knex, RENAMES.map(([from, to]) => [to, from]));
}
