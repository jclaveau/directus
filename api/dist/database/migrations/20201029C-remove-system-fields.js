import { merge, uniq } from "../../utils/lodash-es-used.js";
...
const systemFields = [
	...
	for (const [key, value] of Object.entries(row)) if (value !== null && (typeof value === "object" || Array.isArray(value))) row[key] = JSON.stringify(value);
