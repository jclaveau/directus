...
export async function runAst(originalAST, schema, accountability, options) {
    ...
    async function run(collection, children, query, cases, accountability) {
        ...
        dbQuery = await emitter.emitFilter(['items.db.select', `${collection}.db.select`], dbQuery, {
            query,
            collection,
        }, {
            database: knex,
        ...
        rawItems = await emitter.emitFilter(['items.db.selected', `${collection}.db.selected`], rawItems, {
            query,
            collection,
        }, {
            database: knex,
