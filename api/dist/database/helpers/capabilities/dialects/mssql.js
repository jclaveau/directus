...
//#region src/database/helpers/capabilities/dialects/mssql.ts
const env = useEnv();
var CapabilitiesHelperMSSQL = class extends CapabilitiesHelperDefault {
	/**
	...
	*/
	async preservesInsertOrderInReturning() {
		return env["DB_MSSQL_TRUST_BATCH_RETURNING"];
	}
	/**
...
//#endregion
export { CapabilitiesHelperMSSQL };