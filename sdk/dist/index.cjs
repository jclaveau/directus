...
__export(index_exports, {
  ...
  aggregate: () => aggregate,
  auth: () => auth,
  authenticateShare: () => authenticateShare,
  ...
  createContentVersions: () => createContentVersions,
  createDashboard: () => createDashboard,
  createDashboards: () => createDashboards,
  createDirectus: () => createDirectus,
  ...
  deleteContentVersions: () => deleteContentVersions,
  ...
  generateTwoFactorSecret: () => generateTwoFactorSecret,
  ...
  isDirectusError: () => isDirectusError,
  login: () => login,
  logout: () => logout,
  ...
  pong: () => pong,
  promoteContentVersion: () => promoteContentVersion,
  queryToParams: () => queryToParams,
  randomString: () => randomString,
  readActivities: () => readActivities,
  readActivity: () => readActivity,
  readAssetArrayBuffer: () => readAssetArrayBuffer,
  readAssetBlob: () => readAssetBlob,
  readAssetRaw: () => readAssetRaw,
  readCollection: () => readCollection,
  readCollections: () => readCollections,
  readComment: () => readComment,
  readComments: () => readComments,
  readContentVersion: () => readContentVersion,
  ...
  readFieldsByCollection: () => readFieldsByCollection,
  readFile: () => readFile,
  readFiles: () => readFiles,
  readFlow: () => readFlow,
  readFlows: () => readFlows,
  ...
  readGraphqlSdl: () => readGraphqlSdl,
  readItem: () => readItem,
  readItemPermissions: () => readItemPermissions,
  readItems: () => readItems,
  readMe: () => readMe,
  ...
  readWebhooks: () => readWebhooks,
  realtime: () => realtime,
  refresh: () => refresh,
  registerUser: () => registerUser,
  registerUserVerify: () => registerUserVerify,
  rest: () => rest,
  saveToContentVersion: () => saveToContentVersion,
  ...
  throwIfCoreCollection: () => throwIfCoreCollection,
  throwIfEmpty: () => throwIfEmpty,
  triggerFlow: () => triggerFlow,
  updateCollection: () => updateCollection,
  updateCollectionsBatch: () => updateCollectionsBatch,
  updateComment: () => updateComment,
  updateComments: () => updateComments,
  updateContentVersion: () => updateContentVersion,
  updateContentVersions: () => updateContentVersions,
  updateContentVersionsBatch: () => updateContentVersionsBatch,
  updateDashboard: () => updateDashboard,
  updateDashboards: () => updateDashboards,
  updateDashboardsBatch: () => updateDashboardsBatch,
  updateExtension: () => updateExtension,
  updateField: () => updateField,
  updateFile: () => updateFile,
  updateFiles: () => updateFiles,
  updateFilesBatch: () => updateFilesBatch,
  updateFlow: () => updateFlow,
  updateFlows: () => updateFlows,
  updateFlowsBatch: () => updateFlowsBatch,
  updateFolder: () => updateFolder,
  updateFolders: () => updateFolders,
  updateFoldersBatch: () => updateFoldersBatch,
  ...
  updateNotificationsBatch: () => updateNotificationsBatch,
  updateOperation: () => updateOperation,
  updateOperations: () => updateOperations,
  updateOperationsBatch: () => updateOperationsBatch,
  updatePanel: () => updatePanel,
  updatePanels: () => updatePanels,
  updatePanelsBatch: () => updatePanelsBatch,
  updatePermission: () => updatePermission,
  updatePermissions: () => updatePermissions,
  updatePermissionsBatch: () => updatePermissionsBatch,
  updatePolicies: () => updatePolicies,
  updatePoliciesBatch: () => updatePoliciesBatch,
  updatePolicy: () => updatePolicy,
  updatePreset: () => updatePreset,
  updatePresets: () => updatePresets,
  updatePresetsBatch: () => updatePresetsBatch,
  updateRelation: () => updateRelation,
  updateRole: () => updateRole,
  updateRoles: () => updateRoles,
  updateRolesBatch: () => updateRolesBatch,
  updateSettings: () => updateSettings,
  updateShare: () => updateShare,
  updateShares: () => updateShares,
  updateSharesBatch: () => updateSharesBatch,
  updateSingleton: () => updateSingleton,
  updateTranslation: () => updateTranslation,
  updateTranslations: () => updateTranslations,
  updateTranslationsBatch: () => updateTranslationsBatch,
  updateUser: () => updateUser,
  updateUsers: () => updateUsers,
  updateUsersBatch: () => updateUsersBatch,
  updateWebhook: () => updateWebhook,
  updateWebhooks: () => updateWebhooks,
  uploadFiles: () => uploadFiles,
  utilitySort: () => utilitySort,
  utilsExport: () => utilsExport,
