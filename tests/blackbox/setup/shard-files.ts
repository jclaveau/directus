...
const DURATION_HINTS_MS: Record<string, number> = {
	...
	// Then three idle pools drained by halves, and one whose victim holds its
	// exit for the planner's twenty seconds, watched draining and then gone.
	// Estimated from the arms added since it was measured; to be measured.
