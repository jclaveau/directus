...
import { isIn, parseJSON, toArray, toBoolean } from "@directus/utils/values";
...
const TYPE_MAP = {
	...
	PM2_HOME: "string",
	PM2_INSTANCES: "number",
	PM2_EXEC_MODE: "string",
	PM2_MAX_MEMORY_RESTART: "string",
	PM2_MIN_UPTIME: "number",
	PM2_LISTEN_TIMEOUT: "number",
	PM2_KILL_TIMEOUT: "number",
	PM2_MAX_RESTARTS: "number",
	PM2_RESTART_DELAY: "number",
	PM2_AUTO_RESTART: "string",
	PM2_LOG_ERROR_FILE: "string",
	PM2_LOG_OUT_FILE: "string",
	PM2_AUTOSCALE_ENABLED: "boolean",
	PM2_AUTOSCALE_APP_NAME: "string",
	PM2_AUTOSCALE_SIGNAL: "string",
	PM2_AUTOSCALE_STRATEGY: "string",
	PM2_AUTOSCALE_SAMPLE_WINDOW: "number",
	PM2_AUTOSCALE_SCALE_CPU_THRESHOLD: "number",
	PM2_AUTOSCALE_RELEASE_CPU_THRESHOLD: "number",
	PM2_AUTOSCALE_MIN_WORKERS: "number",
	PM2_AUTOSCALE_MAX_WORKERS: "number",
	PM2_AUTOSCALE_PREWARM: "number",
	PM2_AUTOSCALE_MIN_SECONDS_TO_ADD_WORKER: "number",
	PM2_AUTOSCALE_MIN_SECONDS_TO_RELEASE_WORKER: "number",
	PM2_AUTOSCALE_WARMUP_SECONDS: "number",
	PM2_AUTOSCALE_DRILL_ENABLED: "boolean",
	PM2_POOL_HEALTH_REFRESH: "string",
	...
	MIGRATIONS_STATEMENT_TIMEOUT: "string",
	MIGRATIONS_LOCK_TIMEOUT: "string",
	MIGRATIONS_IDLE_IN_TRANSACTION_SESSION_TIMEOUT: "string",
...
const DEFAULTS = {
	...
	RATE_LIMITER_CHARGE: "cache-misses",
	...
	CACHE_STATS_DRAIN_SCHEDULE: "*/10 * * * * *",
	CACHE_STATS_RETENTION_SCHEDULE: "*/10 * * * *",
	CACHE_STATS_MAX_BYTES: "2gb",
	CACHE_STATS_MAX_BUFFER: 1e6,
	...
	PGBOUNCER_REPORT_ENABLED: false,
	PGBOUNCER_CONNECTIONS: "",
	PGBOUNCER_QUERY_TIMEOUT: "2s",
...
const DIRECTUS_VARIABLES = [
	...
	"CACHE_KEY_HASH_ENABLED",
	"CACHE_TTL",
	"CACHE_CONTROL_S_MAXAGE",
	"CACHE_AUTO_PURGE",
	"CACHE_AUTO_PURGE_MODE",
	"CACHE_AUTO_PURGE_IGNORE_LIST",
	"CACHE_VARY_CONTENT_TYPES",
	"CACHE_VARY_REQUEST_HEADERS",
	"CACHE_VARY_REQUEST_HEADERS_EXCLUDED",
	"CACHE_AUTO_FLUSH_ON_DEPLOY",
	"CACHE_AUTO_FLUSH_ON_DEPLOY_TIMEOUT",
	"CACHE_FLUSH_TIMEOUT",
	"CACHE_BUILD_ID",
	"CACHE_SYSTEM_TTL",
	"CACHE_SCHEMA",
	...
	"CACHE_STATUS_HEADER",
	"CACHE_TAGS_HEADER",
	"CACHE_TAGS_HEADER_MAX_SIZE",
	"CACHE_PURGED_TAGS_HEADER",
	"CACHE_VALUE_MAX_SIZE",
	"CACHE_SKIP_ALLOWED",
	"CACHE_HEALTHCHECK_THRESHOLD",
	"CACHE_STATS_ENABLED",
	"CACHE_STATS_RETENTION",
	"CACHE_STATS_DRAIN_SCHEDULE",
	"CACHE_STATS_RETENTION_SCHEDULE",
	"CACHE_STATS_MAX_BYTES",
	"CACHE_STATS_MAX_BUFFER",
	"CACHE_STATS_GAP_LOOKBACK",
	"STORAGE_LOCATIONS",
	"STORAGE_.+_DRIVER",
	"STORAGE_.+_ROOT",
	"STORAGE_.+_KEY",
...
const createEnv = () => {
	...
	for (let [key, value] of Object.entries(rawConfiguration)) {
		let source = fileKeys.has(key) ? "file" : "process";
...
//#endregion
export { cast, useEnv, useEnvSources };