...
//#endregion
//#region src/errors/database-pool-exhausted.d.ts
/**
 ...
 */
type DatabasePoolExhaustedReason = 'client_pool_timeout' | 'pool_queue_timeout' | 'max_client_connections' | 'too_many_connections';
interface DatabasePoolExhaustedExtensions {
  reason: DatabasePoolExhaustedReason;
  connection: string | null;
}
declare const DatabasePoolExhaustedError: DirectusErrorConstructor<DatabasePoolExhaustedExtensions>;
//#endregion
...
type ForeignKeyViolationReason = 'invalid_reference' | 'still_referenced';
type ForeignKeyViolationOperation = 'create' | 'update' | 'delete';
