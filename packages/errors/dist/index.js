...
// src/injected-dependencies.ts
var injectedDependencies = {};
function injectErrorsDependencies(emitter, env) {
...
var messageConstructor4 = ({ collection, field, value }) => {
...
var messageConstructor11 = ({ collection, field, value }) => {
  let message = "Value ";
  if (value) {
    message += `"${value}" `;
  }
...
var messageConstructor16 = ({ collection, field, value }) => {
...
var messageConstructor17 = ({ collection, field, value }) => {
  let message = "Value ";
  if (value) {
    message += `"${value}" `;
  }
