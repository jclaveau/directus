...
program
    ...
    .option('-e, --external <deps>', 'comma-separated dependencies the api entry resolves at runtime, not bundled')
    .option('--preserve-modules', 'emit the api entrypoint as one file per module, to read rather than to run')
