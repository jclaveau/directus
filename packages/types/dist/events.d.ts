...
export type FilterHandler<TIn = unknown, TOut = TIn, TContext extends EventContext = EventContext> = (payload: TIn, meta: Record<string, any>, context: TContext) => TIn | TOut | Promise<TIn | TOut>;
